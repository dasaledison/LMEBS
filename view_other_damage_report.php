                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td colspan="2"><img src="uploads/<?php echo $damage_report['picture']; ?>" class="img-fluid damage-image" alt="Damage Picture"></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Report ID:</strong></td>
                                        <td><?php echo $damage_report['report_id']; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Cause:</strong></td>
                                        <td><?php echo $damage_report['cause']; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Notes:</strong></td>
                                        <td><?php echo $damage_report['notes']; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Report Status:</strong></td>
                                        <td><?php echo $damage_report['report_status']; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Report Created:</strong></td>
                                        <td><?php echo $damage_report['report_created']; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php
        ...
        redirect('lab_damage_report.php'); // Redirect to lab_damage_report.php or any other appropriate page
    }
} else {
