...
/*--------------------------------------------------------------*/
  private function insert_media(){
         ...
         global $db;
         $sql  = "INSERT INTO media ( product_img,file_type )";
         $sql .=" VALUES ";
         $sql .="(
  ...
  private function insert_media_products(){

    global $db;
    $sql  = "INSERT INTO products ( product_img,file_type )";
    $sql .=" VALUES ";
    $sql .="(
             '{$db->escape($this->fileName)}',
             '{$db->escape($this->fileType)}'
...
/*--------------------------------------------------------------*/
   public function media_destroy($id,$product_img){
     $this->fileName = $product_img;
