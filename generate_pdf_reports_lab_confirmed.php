...
if (isset($_GET['report'])) {
    ...
    $pdf->Cell(0, 10, 'Confirmed Lab Damage Reports', 0, 1, 'C', 1);
    ...
    $sql_borrower = "SELECT * FROM lab_damage_reports WHERE report_status = 'Confirmed'";
    ...
    ob_end_clean();
    $pdf->Output('confirmed_lab_reports.pdf', 'D');
} else {
