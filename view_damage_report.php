...
if (isset($_GET['report_id'])) {
    ...
    $damage_report = find_report_by_report_id('borrower_damage_report', $report_id);
            ...
            .damage-image {
                ...
                height: auto; /* Maintain aspect ratio */
                            ...
                            <div class="row">
                                ...
                                <li class="list-group-item"><strong>School ID:</strong> <?php echo $damage_report['school_id']; ?></li>
                                <li class="list-group-item"><strong>Borrower ID:</strong> <?php echo $damage_report['borrower_id']; ?></li>
